...
function Signup({ updatePostFormData, addUser }) {
    ...
    return (
        <div>
            {formSubmitted ? "Registration Success. Welcome to Simply Beverages." :
                <form onSubmit={event => {
                    addUser(event)
                    ...
                    <div>
                        ...
                        <input onChange={updatePostFormData} type="password" name="password" placeholder="password" required />
                    </div>
